...
ERROR_PDF_DIR_NAME = 'error'
ERROR_PDF_DIR = path.join(PDF_DIR, ERROR_PDF_DIR_NAME)

OCR_PDF_DIR_NAME = 'ocr'
OCR_PDF_DIR = path.join(PDF_DIR, OCR_PDF_DIR_NAME)

CSV_DIR_NAME = 'csv'
CSV_DIR = path.join(DATA_DIR, CSV_DIR_NAME)

OCR_CSV_DIR_NAME = 'ocr'
OCR_CSV_DIR = path.join(CSV_DIR, OCR_CSV_DIR_NAME)
